...
const BLOG_POSTS = [
  ...
  },
  {
    ...
    category: 'technology',
    categoryLabel: 'Technology',
    image: 'request-service/request-service-1.webp',
    author: 'Field Engineer Team',
    authorInitials: 'FE',
    date: 'Apr 12, 2025',
    readTime: '7 min read',
...
function initBlogPage(root) {
  const staticBase = root.dataset.staticBase || '/static/img/';
